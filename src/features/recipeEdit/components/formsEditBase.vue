<template>
    <form @submit.prevent="submitForm">
      ...
      <button type="submit" class="add-button-adicionar" :disabled="isFormIncomplete">EDITAR</button>
      <AlertBox :show="showAlert" @close="closeAlert" />
    </form>
  </template>
  
  <script>
  import { useRecipeEditViewModel } from '../viewmodels/RecipeEditViewModel';
  export default {
    setup() {
      const {
        nome,
